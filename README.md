...
### Figure 2: The responses generated by our chatbot implementation for the same set of questions, when trained on the RCC dataset (top) and when trained on the CMDC dataset (bottom).
